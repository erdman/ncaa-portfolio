...
let globaldata = {};
window.location.hash = window.location.hash || "#Leaderboard/2018";  // sets hash to default if no hash given
$("#year").val(window.location.hash.split('/')[1] || '2018');        // sets year dropdown to value in hash or default if no year hash given
