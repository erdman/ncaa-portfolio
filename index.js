...
const bowl_week = {2016: 16, 2017: 16, 2018: 16, 2019: 16, 2020: 17, 2021: 16, 2022: 16, 2023: 16};
...
let globaldata = {};
window.location.hash = window.location.hash || "#Leaderboard/2023";  // sets hash to default if no hash given
$("#year").val(window.location.hash.split('/')[1] || '2023');        // sets year dropdown to value in hash or default if no year hash given
