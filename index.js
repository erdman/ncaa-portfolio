...
function calculateScore(hero, villain, fbs_name_set, game, new_years_six, year) {
    ...
    const HERO_WIN = hero.currentScore > villain.currentScore;

    const score = {win: win_points[HERO_WIN][VILLAIN_FBS],
...
const bowl_week = {2016: 16, 2017: 16, 2018: 16, 2019: 16, 2020: 17, 2021: 16, 2022: 16, 2023: 16, 2024: 17, 2025: 17, 2026: 17};
...
let globaldata = {};
window.location.hash = window.location.hash || "#Leaderboard/2026";  // sets hash to default if no hash given
$("#year").val(window.location.hash.split('/')[1] || '2026');        // sets year dropdown to value in hash or default if no year hash given
